...
function upImg() {
    ...
    $.ajax({
        ...
        url: "http://cinscby.natapp1.cc/user/uploadHeadPic",
        type: "post",
        data: file,
        cache: false,
        contentType: false,
...
function AccPolish() {
    ...
    if (ischeck == 1) {
        ...
        $.ajax({
            ...
            url: "http://cinscby.natapp1.cc/user/updateUser",
            type: "post",
            dataType: "json",
            data: {
                username    : username,
...
window.onload = function () {
    $.ajax({
        ...
        url: "http://cinscby.natapp1.cc/user/getOwnerMsg",
        type: "get",
        dataType: "json",
        success: function(data) {
            var a = data['data'];
            ...
            $('#pic').attr("src",'http://cinscby.natapp1.cc'+a['headPortrait']);
        },
        error: function() {
            alert("失败，请稍后再试");
        }
